...
namespace MESFeedClientLibrary.Model.BlueMountaion
{
    ...
    public class AssetDownload : IMessage
    {
        ...
        public AssetDownload( string assetid, string assetdesc, string assetstatus, DateTime? nextdue)
        {
            this.TransactionId = Guid.NewGuid();
            this.TransactionDateTime = DateTimeOffset.Now;
            this.MessageID = string.Empty;
            this.EquipmentId = assetid;
            this.EquipmentDescription = assetdesc;
            this.EquipmentStatus = assetstatus;
            this.NextCalibrationDueDate = nextdue;
        }
        public AssetDownload(string messageid, string assetid, string assetdesc, string assetstatus, DateTime? nextdue)
        {
            this.TransactionId = Guid.NewGuid();
            this.TransactionDateTime = DateTimeOffset.Now;
